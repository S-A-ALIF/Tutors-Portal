...
const ActionButton = ({ bg, stroke, label, svgPath, to }) => (
  <NavLink 
    to={to} 
    className={({ isActive }) => 
      `block bg-white border rounded-[10px] p-[12px] text-center cursor-pointer transition-all duration-150 hover:shadow-[0_2px_16px_rgba(40,40,100,0.08)] hover:-translate-y-[1px] ${
        isActive 
          ? "border-blue-400 shadow-[0_2px_16px_rgba(59,91,219,0.12)]" 
          : "border-[rgba(60,60,120,0.10)]"
      }`
    }
  >
    <div 
      className="w-[32px] h-[32px] rounded-[8px] mx-auto mb-[8px] flex items-center justify-center" 
      style={{ background: bg }}
    >
      <svg 
        width="16" 
...
const QuickActionsSection = () => (
  <div className="grid grid-cols-4 gap-[10px] mb-[14px]">
    ...
    <ActionButton 
      ...
      svgPath='<rect x="2" y="5" width="20" height="14" rx="2"/><line x1="2" y1="10" x2="22" y2="10"/>' 
    />
    <ActionButton 
      to="/create-exam" 
      bg="rgba(156,54,181,0.1)" 
      stroke="#9c36b5" 
      label="Create Exam" 
